"""
Inventory tools implementation for MCP-Odoo
"""
...
def register_inventory_tools(mcp: FastMCP) -> None:
    ...
    @mcp.tool(description="Check stock availability for one or more products")
    ...
    @mcp.tool(description="Create an inventory adjustment to correct stock")
    def create_inventory_adjustment(
        ctx: Context,
        adjustment: InventoryAdjustmentCreate
    ) -> Dict[str, Any]:
        """
        Create an inventory adjustment to correct stock
        
        Args:
            adjustment: Adjustment data to create
        ...
        try:
            ...
            # In Odoo 13.0+, use 'stock.inventory'
            # In Odoo 15.0+, use 'stock.quant' directly
            ...
            if inventory_model_exists:
                # Use stock.inventory flow (Odoo 13.0, 14.0)
                ...
                # Use stock.quant flow (Odoo 15.0+)
                result_ids = []
    ...
    @mcp.tool(description="Calculate and analyze inventory turnover")
    def analyze_inventory_turnover(
        ...
        try:
            ...
            for product in products:
                ...
                # 1. Get outgoing movements (sales) in the period
                outgoing_domain = [
                ...
                # Try to get inventory valuation at start and end of period
                ...
                if avg_inventory_value > 0:
                    ...
                    # Inventory days (based on analyzed period)
                ...
                product_turnover[product_id] = {
                    ...
                    "category": product["categ_id"][1] if product["categ_id"] else "No category",
                    "cogs": cogs,
            ...
            # Sort products by turnover (highest to lowest)
