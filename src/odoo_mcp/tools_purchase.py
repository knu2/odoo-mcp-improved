"""
Purchase tools implementation for MCP-Odoo
"""
...
def register_purchase_tools(mcp: FastMCP) -> None:
    """Registers purchase-related tools"""
    
    @mcp.tool(description="Search for purchase orders with advanced filters")
    def search_purchase_orders(
        ctx: Context,
        filters: PurchaseOrderFilter
    ) -> Dict[str, Any]:
        """
        Search for purchase orders based on specified filters
        
        Args:
            filters: Filters for purchase order search
    ...
    def create_purchase_order(
        ...
        try:
            ...
            # Get information about the created order
    ...
    @mcp.tool(description="Analyzes supplier performance")
    def analyze_supplier_performance(
        ctx: Context,
        params: SupplierPerformanceInput
    ) -> Dict[str, Any]:
        """
        Analyze supplier performance for a specific period
        ...
        try:
            ...
            for supplier_id, data in supplier_data.items():
                ...
                # Remove detailed orders list to reduce response size
