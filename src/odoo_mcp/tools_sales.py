"""
Sales tools implementation for MCP-Odoo
"""
...
def register_sales_tools(mcp: FastMCP) -> None:
    ...
    def search_sales_orders(
        ...
        """
        Search for sales orders based on specified filters
        
        Args:
            filters: Filters for sales order search
    ...
    def create_sales_order(
        ...
        Args:
            order: Data for the order to create
    ...
    def analyze_sales_performance(
        ...
        try:
            ...
            # Group according to group_by parameter
            grouped_data = {}
            if params.group_by:
