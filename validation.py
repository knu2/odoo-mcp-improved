"""
Validation script to test the new MCP-Odoo functionalities
"""
...
# Add src directory to path to be able to import odoo_mcp
...
def run_validation():
    ...
    try:
        ...
        print("✅ Odoo connection established correctly")
    ...
    try:
        ...
        print("✅ Prompts imported correctly")
    except Exception as e:
